...
const renderRow = (item: VolumeList) => (
  ...
  >
    ...
    <td className="flex items-center gap-2 p-4">
      {item.proposedVolume != null
        ? item.proposedVolume.toLocaleString() // Add commas if it's a number
        : "-"}
    </td>
    ...
    {/* <td className="hidden md:table-cell ">
      ...
      {item.actualProduction != null
        ? item.actualProduction.toLocaleString() // Add commas if it's a number
        : "-"}
    </td> */}
    <td className="hidden md:table-cell ">
...
const tabs = [
  { label: "Proposed Volume", value: "volumes", link: "/list/volumes" },
  {
    label: "Committed Volume",
    value: "commitedVolume",
...
const VolumeListPage = async ({
  ...
  const columns = [
    ...
    {
      header: "Proposed Volume",
      accessor: "proposedVolume",
      className: "p-4",
    },
    {
      header: "Date Created",
